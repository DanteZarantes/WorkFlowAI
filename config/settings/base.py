"""
Base Django Settings for NeuralFlow Project

This file contains the base configuration settings that are shared across
...
To use these settings, set DJANGO_SETTINGS_MODULE to:
...
MIDDLEWARE = [
    ...
    'utils.middleware.JSONStorageMiddleware',
